...
> The Python scripts to perform the prediction on crime rates mentioned in this article are hosted in my [**Github Repo**](https://github.com/dineshnaidu10/Amazon-Prime-Data-Analysis-NoSQL-). Should anyone require the Power BI dashboard file of this project, you may do so by requesting it via [LinkedIn](https://www.linkedin.com/in/dineshnaidu1014/).
{: .prompt-info }
